...
const client = new Eureka({
    instance: {
        instanceId: `driver:${Math.random().toString(36).substr(2, 16)}`,
        app: 'driver',
        hostName: 'localhost',
        ipAddr: '127.0.0.1',
        port: {
        ...
        findOrderId: 'http://localhost:3001/dispatcher/findOrder/:id',
        dataCenterInfo: {
...
app.post('/driver/register', UserController.register);

app.post('/driver/findOrder/:id', UserController.findOrder);
